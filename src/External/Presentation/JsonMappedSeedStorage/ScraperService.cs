...
public class ScraperService : IScraperService
{
    ...
    {
        var jsonFilePath = Path.Combine(_env.ContentRootPath, "JsonMappedSeedStorage", "WorkoutFiles", "Calves_Tibialis_Soleus_Gastrocnemius.json");
        ...
        string filePath = Path.Combine(outputFolderPath, "WorkoutUpdateInstructionFiles", "Calves_Tibialis_Soleus_Gastrocnemius.json");
