...
public interface IScrapeInstructionService
{
    Task<string> ScrapeTotalInstruction();
}

public class ScrapeInstructionService : IScrapeInstructionService
{
    ...
    public ScrapeInstructionService(IHttpClientFactory clientFactory, IWebHostEnvironment env)
    {
    ...
    public async Task<string> ScrapeTotalInstruction()
    {
        ...
        foreach (var workout in workouts)
        {
            ...
            if (workout.Instruction != null && workout.Instruction.Count > 0 )
                continue;
