...
public static class BackWorkoutDbInitializer
{
    public static async Task BackWorkoutSeedAsync(FitnessContext context)
    {
        ...
        workoutLevel = new List<WorkoutLevel>
        {
            ...
            #region Lower back & Kettlebell
            new WorkoutLevel{ WorkoutId = backWorkouts[183].Id , Level = Difficulty.Beginner },
            new WorkoutLevel{ WorkoutId = backWorkouts[184].Id , Level = Difficulty.Intermediate },
            new WorkoutLevel{ WorkoutId = backWorkouts[185].Id , Level = Difficulty.Beginner },
            new WorkoutLevel{ WorkoutId = backWorkouts[186].Id , Level = Difficulty.Novice },
            new WorkoutLevel{ WorkoutId = backWorkouts[187].Id , Level = Difficulty.Intermediate },
            new WorkoutLevel{ WorkoutId = backWorkouts[188].Id , Level = Difficulty.Beginner },
            new WorkoutLevel{ WorkoutId = backWorkouts[189].Id , Level = Difficulty.Intermediate },
            new WorkoutLevel{ WorkoutId = backWorkouts[190].Id , Level = Difficulty.Intermediate },
            new WorkoutLevel{ WorkoutId = backWorkouts[191].Id , Level = Difficulty.Beginner },
            new WorkoutLevel{ WorkoutId = backWorkouts[192].Id , Level = Difficulty.Beginner },
            new WorkoutLevel{ WorkoutId = backWorkouts[193].Id , Level = Difficulty.Intermediate },
            new WorkoutLevel{ WorkoutId = backWorkouts[194].Id , Level = Difficulty.Intermediate },
            new WorkoutLevel{ WorkoutId = backWorkouts[195].Id , Level = Difficulty.Beginner },
            new WorkoutLevel{ WorkoutId = backWorkouts[196].Id , Level = Difficulty.Advanced },
            new WorkoutLevel{ WorkoutId = backWorkouts[197].Id , Level = Difficulty.Advanced },
            new WorkoutLevel{ WorkoutId = backWorkouts[198].Id , Level = Difficulty.Intermediate },
            new WorkoutLevel{ WorkoutId = backWorkouts[199].Id , Level = Difficulty.Advanced },
            new WorkoutLevel{ WorkoutId = backWorkouts[200].Id , Level = Difficulty.Intermediate },
        ...
        bodyWorkouts = new List<BodyWorkout>
        {
            ...
            new BodyWorkout{ BodyId = lowerBackId, WorkoutId = backWorkouts[187].Id, Target = PriorityTarget.Secondary },
            new BodyWorkout{ BodyId = lowerBackId, WorkoutId = backWorkouts[188].Id, Target = PriorityTarget.Tertiary },
            new BodyWorkout{ BodyId = lowerBackId, WorkoutId = backWorkouts[189].Id, Target = PriorityTarget.Tertiary },
            ...
            new BodyWorkout{ BodyId = lowerBackId, WorkoutId = backWorkouts[195].Id, Target = PriorityTarget.Secondary },
            new BodyWorkout{ BodyId = lowerBackId, WorkoutId = backWorkouts[196].Id, Target = PriorityTarget.Primary },
            new BodyWorkout{ BodyId = lowerBackId, WorkoutId = backWorkouts[197].Id, Target = PriorityTarget.Primary },
            new BodyWorkout{ BodyId = lowerBackId, WorkoutId = backWorkouts[198].Id, Target = PriorityTarget.Tertiary },
            new BodyWorkout{ BodyId = lowerBackId, WorkoutId = backWorkouts[199].Id, Target = PriorityTarget.Secondary },
