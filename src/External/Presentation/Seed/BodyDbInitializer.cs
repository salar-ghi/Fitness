    ...
    public static async Task BodySeedAsync(FitnessContext context)
    {
        ...
        if (!context.Bodies.Any())
        {
            ...
            bodies = new List<Body>
            {
                ...
                new Body { Name = "UpperChest (Upper Pectoralis)", Description = ""},
                new Body { Name = "Mid Chest (Middle Pectoralis)", Description = ""},
                new Body { Name = "Lower Chest (Lower Pectoralis)", Description = ""},
