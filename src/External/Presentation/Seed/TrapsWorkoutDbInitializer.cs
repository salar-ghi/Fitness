...
public class TrapsWorkoutDbInitializer
{
    ...
    public static async Task WorkoutSeedAsync(FitnessContext context)
    {
        ...
        Workouts = new List<Workout>
        {
            ...
            // Abdominals // Machine
            new Workout{ Name = "Machine Roll Outs", SportId = bodybuildingId, Description = "" },                                      // index => 1
            new Workout{ Name = "Rower Knee Tuck", SportId = bodybuildingId, Description = "" },                                        // index => 1
            new Workout{ Name = "Rower Pike", SportId = bodybuildingId, Description = "" },                                             // index => 1
            new Workout{ Name = "Machine Plate Loaded Crunch", SportId = bodybuildingId, Description = "" },                            // index => 1
            new Workout{ Name = "Machine Crunch", SportId = bodybuildingId, Description = "" },                                         // index => 1
        ...
        workoutLevel = new List<WorkoutLevel>
        {
            ...
            new WorkoutLevel{ WorkoutId = Workouts[7].Id , Level = Difficulty.Beginner},
            new WorkoutLevel{ WorkoutId = Workouts[7].Id , Level = Difficulty.Intermediate},
